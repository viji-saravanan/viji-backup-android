...
| Remove commits but grant release fails             | Keep mapping removed, mark cleanup pending, retry release on initialization          | None unless repeated                       | Crash/compensation test          |
